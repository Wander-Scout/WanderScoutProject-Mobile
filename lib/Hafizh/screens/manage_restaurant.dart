...
class ManageRestaurantsScreenState extends State<ManageRestaurantsScreen> {
  ...
  Restaurant? _selectedRestaurant; // If not null, we are editing
  ...
  // We use this bool to ensure we only fetch once
  bool _fetchedOnce = false;

  @override
  void initState() {
    super.initState();
    // We remove _fetchRestaurants() from here
    _searchController.addListener(_filterRestaurants);
  }

  /// Called after initState(), and whenever dependencies change.
  /// We fetch restaurants here to avoid 'dependOnInheritedWidgetOfExactType' errors.
  @override
  ...
  Future<void> _fetchRestaurants() async {
    ...
    // Capture messenger here to avoid 'use_build_context_synchronously'
  ...
  Future<void> _submitAddForm() async {
    ...
    try {
      ...
      final response = await apiService.post(
        url: 'http://127.0.0.1:8000/restaurant/add-restaurant/',
        body: {
          'name': _addName,
